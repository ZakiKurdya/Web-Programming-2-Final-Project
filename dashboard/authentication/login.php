...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($login_result && mysqli_num_rows($login_result) > 0) {
        if ($data['status'] == 1) {
            ...
            $_SESSION['active_user'] = intval($data['id']);
            header("Location:../main/index.php");
        }else {
            $errors['not_allowed'] = "Your account has not been activated. Check with the admins and activate your account to log in";
        }
    }
}
?>
...
<head>
  ...
  <link rel="icon" href="../app-assets/images/ico/logo.png">
                ...
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1">
                      ...
                      <img src="../app-assets/images/logo/logo.png" alt="branding logo" width="200">
                        <br>
                        <h2>Stores Rating System</h2>

                        <?php
                        if (!empty($errors['not_allowed'])) {
                            echo "<span class='text-danger'>" . $errors['not_allowed'] . "</span>";
                        }
                        ?>
                    </div>
                  </div>
